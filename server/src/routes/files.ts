...
const VALID_FILE_TYPES = ['FLOOR_PLAN', 'LIFESTYLE_CAPTURE', 'PITCH_PRESENTATION', 'QUOTATION', 'GENERATED_QUOTE', 'PAYMENT_SCREENSHOT', 'OB_QUOTE', 'WELCOME_MAIL_SCREENSHOT', 'OTHER'] as const;
